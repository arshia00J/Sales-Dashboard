  ...
  return (
    <div className="w-full hidden xl:flex justify-between items-center px-6 py-3 border-b-[2px] border-[#E7E7E7] bg-white">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative p-2 bg-[#F6F6F6] rounded-[9px]">
          <Image
            src="/images/mail.png"
            alt="mail"
            width={20}
            height={20}
          />
          <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[8px] font-semibold w-[13px] h-[12px] rounded-[2px] flex items-center justify-center">
            2
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <div className="flex flex-col">
            <p className="text-sm font-semibold text-gray-800">Guy Hawkins</p>
            <p className="text-xs text-gray-400">Admin</p>
            
          </div>
          <span className="w-[11px] h-[11px] bg-[#23A149] rounded-full absolute left-8 top-8" />
        </div>
      </div>
    </div>
  );
