              ...
              <tr key={index} className="border-t border-[#E7E7E7] dark:border-[#3D3D3D]">
                ...
                <td className="px-2">
                  <div className="flex gap-2">
                    <Image src={"/simages/eye-open.png"} alt="eye" width={20} height={20} className="dark:invert" />
                    <Image src={"/simages/edit-03.png"} alt="edit" width={20} height={20} className="dark:invert"/>
                    <Image onClick={() => deleteHandler(item.sku, index)} className="cursor-pointer dark:invert" src={"/simages/delete-1.png"} alt="delete" width={20} height={20} />
                  </div>
                </td>
              </tr>
            ))}
            ...
            <div className="flex flex-col gap-3 mt-3 ml-9 text-sm">
              ...
              <div className="flex items-center">
                ...
                <div className="flex gap-4">
                  <Image src={"/simages/eye-open.png"} alt="eye" width={24} height={24} className="dark:invert" />
                  <Image src={"/simages/edit-03.png"} alt="edit" width={24} height={24} className="dark:invert"/>
                  <Image onClick={() => deleteHandler(item.sku, index)} src={"/simages/delete-1.png"} alt="delete" width={24} height={24} className="cursor-pointer dark:invert" />
                </div>
              </div>
            </div>
          )}
