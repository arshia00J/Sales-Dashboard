  ...
  return (
    ...
    <div className="flex justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <Image src={"/simages/Icon_right.png"} alt="left icon" width={32} height={28} className="rotate-180 dark:invert"/>
        </button>
        <button
          onClick={handleNext}
          ...
          className="cursor-pointer disabled:opacity-50"
        >
          <Image src={"/simages/Icon_right.png"} alt="right icon" className="dark:invert" width={32} height={28}/>
        </button>
      </div>
    </div>
